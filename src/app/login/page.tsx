                    ...
                    <form action={formAction} className="space-y-4">
                        {error && (
                            <div className="p-3 bg-red-50 text-red-600 border border-red-200 rounded-lg text-xs font-semibold">
                                {error.error || "E-mail ou senha incorretos."}
                            </div>
                        )}
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="#" className="text-[10px] font-semibold text-blue-600 hover:text-blue-700">
                                    Esqueceu a senha?
                                </Link>
                            </div>
                        ...
                        <Button disabled={isPending} className="w-full h-10 mt-2 bg-slate-900 hover:bg-slate-800 text-white gap-2 font-semibold">
                            <LogIn size={16} /> {isPending ? "Entrando..." : "Entrar no sistema"}
                        </Button>
                    </form>
